      ...
      <v-layout class="fill-height" tag="v-list" column>
        <v-list-tile avatar>
          <v-list-tile-avatar  color="white">
            <v-img src="https://www.stu.ru/user_img/45_10.gif" height="34" contain/>
          </v-list-tile-avatar>
          <v-list-tile-title class="title">Деканат-ИНФО</v-list-tile-title>
        </v-list-tile>
        <v-divider/>
        ...
        >
          ...
          <v-list-tile-title class="font-weight-light">Родишев Денис</v-list-tile-title>
        </v-list-tile>
      </v-layout>
    </v-img>
  </v-navigation-drawer>
